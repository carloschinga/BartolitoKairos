...
@RestController
@RequestMapping("/kairos/presentaciones")
public class KairosPresentacionRestController {

	@Autowired
	private KairosPresentacionesFacade kairosPresentacionesFacade;

	@PostMapping("/saveOrUpdateFile")
	public BaseOperacionResponse saveOrUpdateFile(@RequestBody MultipartFile file) {
		return kairosPresentacionesFacade.saveOrUpdateFile(file);
	}
