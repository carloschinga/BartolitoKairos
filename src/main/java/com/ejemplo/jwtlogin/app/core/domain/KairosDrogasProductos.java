...
@NoArgsConstructor
@Entity
@Table(name = "kairos_drogas_productos", schema = Constantes.SCHEMA, catalog = Constantes.CATALOG)
public class KairosDrogasProductos {

	@Id
	@Column(name = "kairos_drogas_productos_id", unique = true, nullable = false)
	private String kairosDrogasProductosId;
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "kairos_drogas_id")
	private KairosDrogas kairosDrogas;
