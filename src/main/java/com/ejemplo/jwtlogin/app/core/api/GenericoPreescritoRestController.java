...
public class GenericoPreescritoRestController {
	...
	@PostMapping("/initMedico")
	public ComboMedicoResponse initComboMedico(@RequestBody GenericoPreescritoComboRequest request) {
		return genericoPreescritoFacade.initComboMedico(request);
	}
