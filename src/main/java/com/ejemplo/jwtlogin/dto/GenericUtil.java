package com.ejemplo.jwtlogin.dto;
...
public class GenericUtil {
	...
	public static String buildCode8Unic() {
        String fechaHora = DateUtil.format(DateUtil.getCurrentLocalDateTime(), DateUtil.FORMAT02);
        String parteFecha = fechaHora.substring(fechaHora.length() - 4);
        int numeroAleatorio = new Random().nextInt(9000) + 1000;
        return parteFecha + numeroAleatorio;
    }
...
//	public static Optional<InputStream> toBase64InputStream(Optional<String> base64String) throws IOException {
